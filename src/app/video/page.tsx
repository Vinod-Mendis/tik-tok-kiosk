...
export default function MyComponent() {
  ...
  return (
    <main className="min-h-screen w-full flex items-center justify-center bg-gray-950 overflow-hidden px-[94px]">
      {/* 9:16 aspect ratio container centered on screen */}
      <div className="aspect-[9/16] w-full max-w-[500px] rounded-lg overflow-hidden shadow-2xl">
